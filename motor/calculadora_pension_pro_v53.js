// ==========================================================================
// CALCULADORA DE PENSIÓN PRO - VERSIÓN COMPLETA v5.3
// NUEVO v5.3 — MOTOR DE RENDIMIENTOS GENERACIONAL (precios reales CONSAR)
...
class PensionCalculator {
    ...
    execute() {
        ...
        this.user_data.saldos_fuente = (Number.isFinite(motor.rcv97) || Number.isFinite(motor.sar92))
            ? "motor_contrafactual" : "estimado_v5.3_generacional";
        ...
        this.user_data.supuestos_rendimiento = {
            motor: "v5.3-generacional-real-urv",
        ...
        return {
            metadata: {
                ...
                server_version: "2.3.0-generational-returns",
