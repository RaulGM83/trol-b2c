...
Orden de preferencia: 1) si getCustomerData trae url_herramienta, úsalo literal (ya incluye su ?c=). 2) el mi_link que devolvió trolAlta en este hilo, o uno nuevo con trolMiLink. 3) respaldo https://app.trol.mx/e/<persona_id>?c=bot con el persona_id real.
...
Tras reenviar el reporte EXACTO, en mensaje SEPARADO aplica §7: una frase que invite a hablar con el experto o entrar a su expediente (url_herramienta literal si viene, o su mi_link — trolMiLink si no lo tienes).
📌 IMPORTANTE
