  ...
  return (
    <div className="rounded-xl border border-line bg-cream/50 p-4">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Campo label="Excedente para la constructora" sub="INTERNO: proporción del sobrante (ya sin notariales regalados) que retiene; 0.25 o 25 valen igual"><input type="number" step="0.05" value={p.pct_excedente_constructora} onChange={(e) => set('pct_excedente_constructora', n(e.target.value))} className={inp} /></Campo>
